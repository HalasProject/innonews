...
function App() {
  ...
  return (
    <div className="App relative">
      {loading && (
        <div className="bg-slate-700 z-50 h-screen w-full absolute flex flex-col space-y-4 justify-center items-center">
          ...
          <div role="status">
            <svg
              aria-hidden="true"
              className="w-8 h-8 mr-2  animate-spin text-gray-600 fill-red-600"
              viewBox="0 0 100 101"
              fill="none"
